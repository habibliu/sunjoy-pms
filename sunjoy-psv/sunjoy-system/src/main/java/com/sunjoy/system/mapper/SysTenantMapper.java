...
public interface SysTenantMapper {
    ...
    @Insert("INSERT INTO sys_tenant (tenant_name, tenant_code, leader, phone, email, region, address, registration_date, payment_method, settlement_cycle, settlement_date, wechat_account, alipay_account, status, del_flag, create_by, create_time) " +
            "VALUES (#{tenantName}, #{tenantCode}, #{leader}, #{phone}, #{email}, #{region}, #{address}, #{registrationDate}, #{paymentMethod}, #{settlementCycle}, #{settlementDate}, #{wechatAccount}, #{alipayAccount}, #{status}, #{delFlag}, #{createBy}, #{createTime})")
