package com.sunjoy.gateway.config;
...
public class SpringDocConfig implements InitializingBean {
    ...
    @Bean
    public static SwaggerUiConfigProperties swaggerUiConfigProperties() {
...
class SwaggerDocRegister extends Subscriber<InstancesChangeEvent> {
    private final static String[] EXCLUDE_ROUTES = new String[]{"sunjoy-gateway", "sunjoy-auth", "sunjoy-file", "sunjoy-monitor"};
    @Autowired
    private SwaggerUiConfigProperties swaggerUiConfigProperties;
    @Autowired
    private DiscoveryClient discoveryClient;
